  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="flex h-9 w-24 shrink-0 flex-row items-center divide-x rounded-br-sm rounded-bl-sm border-r border-b border-l md:h-5 md:w-12"
      >
        <button
          className={`flex h-full flex-2 items-center justify-center rounded-br-sm rounded-bl-sm bg-linear-to-b ${CLOSE_GRADIENT}`}
